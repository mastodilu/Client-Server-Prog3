...
public class Model extends Observable
{
    ...
    public synchronized void setInbox(LinkedList<Mail> ll)
    {
...
//        this.inbox = ll;
    ...
    public synchronized void setSent(LinkedList<Mail> ll)
    {
...
//        System.out.println("Called Model getMessageToDisplay");
    ...
    public synchronized void setMessageToDisplay(String msg)
    {
...
//        System.out.println("Called Model resetMessageToDisplay");
    ...
    public synchronized LinkedList<Mail> orderByDate(LinkedList<Mail> casual)
    {   
...
//        System.out.println("ordered list size is " + ordered.size());
    ...
    public synchronized LinkedList<Mail> orderByPriority(LinkedList<Mail> casual)
    {
