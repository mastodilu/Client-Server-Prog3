...
{
    private JButtonListener bl;//controller
    private JTextAreaClickListener tl;//controller
    private MyComponentListener cl;//controller
    private GUIClient guiClient; //view
    ...
    //set and show a message in the message bar on top of inbox window
//    private void setStatusMessage(String message)
//    {
//        guiClient.getWindow().getMessageArea().setText(message);
//    }
}
